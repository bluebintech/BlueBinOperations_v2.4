<%@ Page Title="BlueBin Time Study - Stage Scanning" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="TimeStudyStageScan.aspx.vb" Inherits="TimeStudyStageScan" %>
