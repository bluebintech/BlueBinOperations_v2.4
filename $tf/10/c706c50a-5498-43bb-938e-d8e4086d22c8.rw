...
<asp:TableRow>
    <asp:TableCell Width="500px"  BorderColor="#032169" BorderStyle="Solid" BorderWidth="1">
        ...
        <asp:Table ID="Table1" runat="server" CellPadding="10" Width="500px" BorderWidth="10" BorderColor="#eeeeee" BackColor="#eeeeee">
            ...
            <asp:TableRow>    
                <asp:TableCell>
                    <asp:Label ID="QCNID" runat="server" Text="QCN ID#" BackColor="#eeeeee"></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
                    <asp:TextBox ID="QCNIDTB" runat="server"  ReadOnly="True" BackColor="#eeeeee"  Width="40px"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow><asp:TableRow Height="10"></asp:TableRow>
            
            <asp:TableRow>    
                <asp:TableCell>
                    <asp:Label ID="LabelDateEntered" runat="server" Text="Date Logged" BackColor="#eeeeee"></asp:Label>
                </asp:TableCell>
                <asp:TableCell >
                    <asp:TextBox ID="DateEnteredTB" runat="server"  ReadOnly="True" BackColor="#eeeeee" DataFormatString="{0:d}" Width="100px"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow><asp:TableRow Height="10"></asp:TableRow>

            <asp:TableRow>    
                <asp:TableCell>
                    <asp:Label ID="LabelDateRequested" runat="server" Text="Date Requested" BackColor="#eeeeee"></asp:Label>
                </asp:TableCell>
                <asp:TableCell >
                    <asp:TextBox ID="DateRequestedTB" runat="server"  ReadOnly="True" BackColor="#eeeeee" DataFormatString="{0:d}" Width="100px"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow><asp:TableRow Height="10"></asp:TableRow>
            
            <asp:TableRow>    
                <asp:TableCell>
                    <asp:Label ID="LabelLastUpdated" runat="server" Text="Date Updated" BackColor="#eeeeee"></asp:Label>
                </asp:TableCell>
                <asp:TableCell >
                    <asp:TextBox ID="LastUpdatedTB" runat="server"  ReadOnly="True" BackColor="#eeeeee" DataFormatString="{0:d}" Width="100px"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow><asp:TableRow Height="10"></asp:TableRow>
            
            <asp:TableRow >    
                <asp:TableCell>
                    <asp:Label ID="LabelDateCompleted" runat="server" Text="Date Completed" BackColor="#eeeeee"></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
                    <asp:TextBox ID="DateCompletedTB" runat="server"  ReadOnly="True" BackColor="#eeeeee" DataFormatString="{0:d}" Width="100px"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow><asp:TableRow Height="10"></asp:TableRow>
            <asp:TableRow> 
                <asp:TableCell>
            ...
            <asp:TableRow>    
                <asp:TableCell>
                    ...
                    ID&nbsp;<asp:TextBox ID="ItemIDTB" runat="server"   Width="100px" TextMode="SingleLine"></asp:TextBox>
                    &nbsp;&nbsp;Par&nbsp;<asp:TextBox ID="ParTB" runat="server"  TextMode="SingleLine" Width="40px"></asp:TextBox>
                    &nbsp;&nbsp;UOM&nbsp;<asp:TextBox ID="UOMTB" style="text-transform:uppercase"  MaxLength="4" runat="server"  TextMode="SingleLine" Width="40px"></asp:TextBox>
            ...
            <asp:TableRow>    
                <asp:TableCell>
                    ...
                    <asp:DropDownList ID="AssignedDD"  AppendDataBoundItems="true" runat="server" DataSourceID="AssignedUserSource" DataTextField="AssignedFullName" DataValueField="AssignedUser">
